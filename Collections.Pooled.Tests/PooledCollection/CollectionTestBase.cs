...
namespace Collections.Pooled.Tests.PooledCollection
{
    public class CollectionTestBase
    {
        ...
        protected static readonly int[] s_excludedFromIntArray = new int[] { 100, -34, 42, Int32.MaxValue, Int32.MinValue };
        ...
        {
            private readonly IListApi _expectedApiCalls;
            ...
            public void AssertAllMembersCalled()
            {
                ...
                {
                    for (var i = (IListApi)1; i < IListApi.End; i = (IListApi)((int)i << 1))
                    {
